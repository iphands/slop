...
| 3 | T3: post-fix soak comparison; close plan (+P49 T2) | `context/brain_notes.md` | done | 8 soaks total; EVT velocity instrumentation → landing_strip_deadly (v23) was the real fix; final: lava deaths 28→21, share 29% |
